...
import { ensureAnonymousSession } from "@/lib/firebase/functions/auth-firebase";
...
export default function LoginPage() {
    ...
    const handleSubmit = async (e?: React.FormEvent) => {
        ...
        try {
            // Primeiro faz login anônimo no Firebase
            await ensureAnonymousSession();

            const { error, message } = await useAuthStore.getState().login({
            ...
            toast({
                ...
                description: err?.message || "Erro ao realizar login.",
            });
        } finally {
            setIsLoading(false);
        }
                        ...
                        {dev_mode && (
                            <div className="mt-2 text-center">
                                <Button
                                    ...
                                    onClick={() =>
                                        setFormData({
                                            login: "paulopx1@pxtalk.com.br",
                                            password: "Acropole2@Two5!",
                                        })
                                    }
                                >
                                    Preencher DEMO
