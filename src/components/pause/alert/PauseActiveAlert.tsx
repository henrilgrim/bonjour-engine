...
export function PauseActiveAlert() {
    ...
    const handleEndPause = async () => {
        // This should be passed as prop from parent component
        console.log("End pause clicked")
    }
                ...
                <CardContent className="p-6">
                    <div className="flex flex-col items-center gap-4 text-center">
                        <div className={cn(
                            ...
                            isTimeExceeded ? "bg-red-100" : "bg-yellow-100"
                        )}>
                            <Clock className={cn(
                                "h-8 w-8",
                                isTimeExceeded ? "text-red-600" : "text-yellow-600"
                            )} />
                        </div>
