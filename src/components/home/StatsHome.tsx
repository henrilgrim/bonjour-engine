...
export function StatsHome({
    ...
    return (
        <div className="guide--container-stats flex flex-col gap-5 h-full max-h-full">
                ...
                <div className="grid gap-4 pb-4">
                    {stats.map((stat, index) => {
                        ...
                        return (
                            <Card
                                key={index}
                                className="group shadow-none rounded-2xl bg-glass backdrop-blur-sm border border-glass-border hover:bg-surface-elevated/50 transition-all duration-300 hover:scale-[1.02] hover:shadow-glow"
                            >
