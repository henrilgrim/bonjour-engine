...
export function AudioPlayerDialog({
    ...
    const [isArmed, setIsArmed] = useState(false); // só libera após clique
    ...
    useEffect(() => {
        if (!open || !id) return;
        setIsArmed(false);
        const find = alreadyHeard.find((a) => a === id);
    ...
    const handleUserPlay = async () => {
        ...
        try {
            ...
            // erro de autoplay bloqueado, ignora
        }
    };
    ...
    const handleClose = () => {
        ...
        if (id && onHeard && isArmed && !audioAlreadyListened) {
            onHeard(id);
        }
        onClose();
        setNotes("");
                        ...
                        <div className="flex items-start gap-2 rounded-md border bg-muted/40 p-3 text-sm">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground">
                                    Este áudio já foi reproduzido anteriormente.
                                    Reproduções adicionais foram desativadas.
                                </p>
                            </div>
                        </div>
                    ) : (
