...
export type LogoutFirebaseOptions = {
    keepAnonymous?: boolean; // default true: apenas signOut; false: apaga anônimo
};
...
export async function logoutFirebase(
    opts: LogoutFirebaseOptions = { keepAnonymous: true }
) {
    ...
    try {
        ...
        console.error("firebase logout failed", {
            code: e?.code,
            message: e?.message,
        });
        try {
